...
const userSchema = new mongoose.Schema({
  ...
  majorCode: {
    ...
    validate: {
      ...
      message: 'Kode program studi harus 3 digit'
    }
  },
  yearEntry: {
    type: Number,
  ...
  npm: {
    ...
    validate: {
      ...
      message: 'NPM harus terdiri dari 9 digit angka'
    }
  },
  email: {
    type: String,
    ...
    validate: {
      validator: function(v) {
        return /^[a-z]+\.\d{8}@stu\.untar\.ac\.id$/.test(v);
      },
      message: 'Email harus menggunakan format Untar (namadepan.npm@stu.untar.ac.id)'
    }
  },
  password: {
    type: String,
